    ...
    <div>
      <header class="banner" role="banner">
        <nav class="navbar" role="navigation" aria-label="menu">
          <Link to="/">
            <img
              src="12371612_4976428__1_-removebg-preview.png"
              width="200"
              height="150"
            />
          </Link>
          ...
          <ul class="menuNav">
            ...
            <Link to="/About">
  <li style={{ cursor: "pointer", marginRight: "35px",color:"#405370" }}>
    ABOUT US
  </li>
</Link>
<Link to="/Contact">
  <li style={{ cursor: "pointer",color:"#405370" }}>
    CONTACT US
  </li>
</Link>


            {/* <p className='navLine absolute bg-red-600 w-1 font-extralight h-9 z-50' style={{ right: '2px' }}>  </p> */}
          </ul>
