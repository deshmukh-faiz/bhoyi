...
const HeroSection = () => {
    return (
        <div className='heroSecMainParent'>
            ...
            <p className='text-4xl mt-20 text-center welcomStore'>WELCOME TO VIOLETTA COLLECTION</p>
            <br />
            <br />


            <p className='heroDescription relative text-xl flex flex-wrap'>Empowering Beauty, Redefining Standards: Welcome to Violetta Collection. Natural Elegance, Nurturing Confidence. </p>
