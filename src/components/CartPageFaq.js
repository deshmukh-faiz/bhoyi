...
const data = {
    ...
    rows: [
...

        {
            ...
            content: `We offer shipping of online purchases to U.S. only at this time. At this time we do not ship outside the United States due to additional taxes and fees imposed by customs. We have other VIOLETTA websites that ship to Australia, New Zealand, Asia, United Kingdom, Europe & Canada.`,
        },
